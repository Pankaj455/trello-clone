...
const ListContainer = ({boards}) => {
    const {addNewList, clearAllLists, loadAllLists, allLists} = useListContext()
    ...
    const createNewList = async (e) => {
        ...
        setLoading(true)
        try {
            const response = await axios.post("/board/list/new",
    ...
    >
        ...
        >
            {addingList ? (
                ...
                >Add {lists?.length === 0 ? "a" : "another"} list</Button>
            )}
        </Box>
    </Flex>
  )
